...
public class Work_with_TreeMap {
    /**
     ...
     */
    public static void Add_to_TreeMap(Map<Integer,City> map, int j, String[] line1) throws ParseException {
     ...
     * @throws ParseException
     */
    public static void Replace_TreeMap(Map<Integer,City> map, int j, String[] line1) throws ParseException {
        map.replace(j, new City(Integer.parseInt(line1[0]), line1[1],
                new Coordinates(Long.parseLong(line1[2]), Integer.parseInt(line1[3])),
                LocalDate.parse(line1[4]), Float.parseFloat(line1[5]),
                Integer.parseInt(line1[6]), Long.parseLong(line1[7]),
                Long.parseLong(line1[8]), Long.parseLong(line1[9]),
                StandardOfLiving.valueOf(line1[10]),
                new Human((new SimpleDateFormat("dd.MM.yyyy HH:mm:ss")).parse(line1[11]))));
    }
     ...
     * @param j
     */
    public static void Remove_ElementTreeMap(int j){
